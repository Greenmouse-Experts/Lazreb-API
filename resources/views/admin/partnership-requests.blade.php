                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table id="example" class="table table-striped table-bordered text-nowrap w-100 dataTable no-footer" role="grid" aria-describedby="example_info">
                                                            ...
                                                            @if($partnershipRequestsIndividual->isEmpty())
                                                            <tbody>
                                                                <tr>
                                                            ...
                                                            @else
                                                            @foreach($partnershipRequestsIndividual as $becomePartner)
                                                            <tbody>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">                                                                    
                                                                    <table id="example" class="table table-striped table-bordered text-nowrap w-100 dataTable no-footer" role="grid" aria-describedby="example_info">
                                                                        ...
                                                                        @if($partnershipRequestsCorporate->isEmpty())
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="align-enter text-dark font-13" colspan="12">No Request.</td>
                                                                            </tr>
                                                                        </tbody>
                                                                        @else
                                                                        @foreach($partnershipRequestsCorporate as $becomePartner)
                                                                        <tbody>
                                                                            <tr role="row" class="odd">
                                                                                <td class="sorting_1">{{$loop->iteration}}</td>
                                                                                <td>
