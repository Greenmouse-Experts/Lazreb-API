                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                         @if(\App\Models\PartnerFleetManagement::where('service_id', $service->id)->get()->isEmpty())
                                        <p>No Request</p>
                                        @else
                                            @foreach(\App\Models\PartnerFleetManagement::where('service_id', $service->id)->get() as $partnerfleetmanagement)
