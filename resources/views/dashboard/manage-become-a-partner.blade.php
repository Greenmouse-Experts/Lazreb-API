                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <div>
                                                        <h3 class="card-title">All Individual Request Sent</h3>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                                    ...
                                                                    <table id="example" class="table table-striped table-bordered text-nowrap w-100 dataTable no-footer" role="grid" aria-describedby="example_info">
                                                                        <thead>
                                                                            <tr role="row">
                                                                                ...
                                                                                <th class="wd-15p sorting">NIN</th>
                                                                        ...
                                                                        @if($becomePartnersIndividual->isEmpty())
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="align-enter text-dark font-13" colspan="9">No Request.</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        @else
                                                                        @foreach($becomePartnersIndividual as $becomePartner)
                                                                            <tbody>
                                ...
                                <div class="card">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div>
                                                    <h3 class="card-title">All Corporate Request Sent</h3>
                                                </div>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <table id="example" class="table table-striped table-bordered text-nowrap w-100 dataTable no-footer" role="grid" aria-describedby="example_info">
                                                                        ...
                                                                        @if($becomePartnersCorporate->isEmpty())
                                                                            <tbody>
                                                                                <tr>
                                                                        ...
                                                                        @else
                                                                        @foreach($becomePartnersCorporate as $becomePartner)
                                                                            <tbody>
                                                                                <tr role="row" class="odd">
                                                                                    <td class="sorting_1">{{$loop->iteration}}</td>
                                                                                    <td>{{$becomePartner->partnership_type}}</td>
