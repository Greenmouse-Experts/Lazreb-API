                ...
                <div class="card">
                    <form method="POST" action="{{ route('user.update.password')}}">
                        ...
                        <div class="card-footer text-right"> 
                            <button type="submit" class="btn btn-success mt-1 form-btn">Change Password</button> 
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-12 col-xl-8 col-md-12 col-sm-12">
                <form method="POST" action="{{ route('user.update.profile')}}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer text-right"> 
                            <button type="submit" class="btn btn-success mt-1 form-btn">Update Profile</button>
                        </div>
                    </div>
                </form>
            </div>
